...
def menlo_cer_sim():
    ...
    vm = powers.Attack("Voltaic Manipulator", "Ranged Combat: Hypersuit Blasters", 10, "Dodge", Character.get_toughness, Character.get_toughness, modifier_values={'Accurate': 10, 'Sleep': 'default', 'Permanent Effect':'default', 'Tertiary Effect':'default', 'Secondary Effect':'default', 'Perception-Ranged':'default', 'Ranged':'default', 'Continuous':'default', 'Reaction':'default', 'Multiattack':'default', 'Selective':'default', 'Subtle':3, 'Fades':'default'})
